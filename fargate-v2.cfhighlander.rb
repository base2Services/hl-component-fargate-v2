CfhighlanderTemplate do
  ...
  Component template: 'github:base2services/hl-component-ecs-task#feature/windows-ecs-task.snapshot', name: "#{component_name.gsub('-','').gsub('_','')}Task", render: Inline, config: @config do
